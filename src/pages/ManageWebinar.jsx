...
const ManageWebinar = () => {
    const { getAllWebinarRegistrations } = useWebinar();
    ...
    const {
        ...
        queryFn: getAllWebinarRegistrations,
    });
    ...
    const deleteRegistration = async (id) => {
        try {
            await axios.delete(
                `${import.meta.env.VITE_API_BASE_URL}/webinar/registrations/${id}`,
                { withCredentials: true }
            );
            refetch();
            Swal.fire("Deleted!", "Webinar registration removed successfully.", "success");
        } catch (error) {
    ...
    const exportToCSV = (data) => {
        ...
        link.setAttribute('download', 'WebinarRegistrations.csv');
        ...
        return (
            <div className="text-center mt-12">
                <h2 className="text-red-600 text-lg font-bold">
                    Error loading webinar registrations
                </h2>
                <button 
                    onClick={() => refetch()}
